...
const QuestionPage = ()  => { 
  ...
  const endQuiz = (e) => {
    console.log('localStorage p1', localStorage.answers);
    // router.push({
    //   pathname :'/charts'
    // })
  }
    ...
    const setAnswer = (e) => { 
      //localStorage.setItem('q1', e.target.value);
      localStorage.setItem('answers', JSON.stringify({'q1' : e.target.value}));
    }
    return (
        <>
            ...
            <div className="px-6">
              ...
              <div className="text-center mt-12">
                <h3 className="text-4xl font-semibold leading-normal mb-2 text-gray-800 mb-2">
                  What would be the border applied as per the below code?
                 </h3>
                <div className="iframe-container ml-32">
                <iframe
  src="https://carbon.now.sh/embed?bg=rgba%28171%2C+184%2C+195%2C+1%29&t=seti&wt=none&l=auto&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=56px&ph=56px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=%253Cdiv%2520id%253D%2522outer-i%2522%2520class%253D%2522outer-c%2522%253E%250A%2509Outer%2520div%250A%253C%252Fdiv%253E%250A%250A%250A%250A%2523outer-i%2520%257B%250A%250A%2520%2520border%253A1px%2520solid%2520red%253B%250A%257D%250A.outer-c%2520%257B%250A%250A%2520%2520border%253A1px%2520solid%2520blue%253B%250A%257D%250A%250A"
                ...
                <div className="flex flex-wrap justify-center text-left">
                  <div className="w-full lg:w-9/12 px-4 rounded">
                    ...
                    <label className="mb-4 text-lg leading-relaxed text-gray-800 ml-4" htmlFor="option1">
                      ID has more priority so a border of 1px solid red would be applied.
                    </label>
                  ...
                  <div className="w-full lg:w-9/12 px-4 rounded">
                    ...
                    Class has more priority so a border of 1px solid blue would be applied.
                    </label>
                  ...
                  <div className="w-full lg:w-9/12 px-4 rounded">
                    ...
                    <label className="mb-4 text-lg leading-relaxed text-gray-800 ml-4" htmlFor="option3" >
                      Nether would be applied due to conflicting css
                    </label>
                  ...
                  <div className="w-full lg:w-9/12 px-4 rounded">
                    ...
                    <label className="mb-4 text-lg leading-relaxed text-gray-800 ml-4" htmlFor="option4">
                      Not Sure, Take me staright to the course!
                    </label>
              ...
              <div className="w-full px-4 lg:order-3 lg:text-right lg:self-center flex justify-center">
                  ...
                  <div className="py-6 px-3 mt-32 sm:mt-0">
                    <button
                      ...
                      type="button"
                    >
                      <Link href="horizontally-center-a-div"> Next2 </Link>
                    </button>
