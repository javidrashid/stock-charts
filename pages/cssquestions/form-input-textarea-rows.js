...
const QuestionPage = ()  => { 
    ...
    const endQuiz = (e) => { 
      console.log('localStorage', localStorage.q4);
    }

    const setAnswer = (e) => { 
      localStorage.setItem('q5', e.target.value);
      //submission.results.push(localStorage.getItem('q5'));

      localStorage.setItem('answers', JSON.stringify(Object.assign({}, JSON.parse(localStorage.getItem('answers')) , {'q5' : e.target.value})));
   }
    return (
        <>
            ...
            <div className="px-6">
              ...
              <div className="text-center mt-12">
                <h3 className="text-4xl font-semibold leading-normal mb-2 text-gray-800 mb-2">
                  Which of the form elememts can take a property of rows and cols?
                </h3>
